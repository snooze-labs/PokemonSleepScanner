...
public class ScannerServiceNotifications {
    public static final int NOTIFICATION_ID = 347;
    private static final String NOTIFICATION_CHANNEL_ID = "com.snoozelabs.scanner.app";
    private static final String NOTIFICATION_CHANNEL_NAME = "com.snoozelabs.scanner.app";
